 ...
 <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
         <div style="margin-left: 30px; margin-right: 30px;" class="collapse navbar-collapse" id="navbarText">
            <ul class="navbar-nav mr-auto">
             ...
             <li class="nav-item">
                 <a style="color: white;" class="nav-link" href="buy_pengadaan.php">Buy</a>
            </li>
            </ul>
            <div class="collapse navbar-collapse" id="navbarText" >
                <ul class="navbar-nav ms-auto mb-5 mb-lg-0">
                <span  style="color: white; margin-right:7px;" class="navbar-text">Hello, Pengadaan!</span>
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <a href="send_pengadaan.php?id_produk=<?php echo $d['id_produk']; ?>" class="btn btn-danger">Send</a>
                                </td>
                            </tr>
                       <?php  
                        }

...
<body>
         ...
         <div style="margin-left: 30px; margin-right: 30px;" class="collapse navbar-collapse" id="navbarText">
            <ul class="navbar-nav mr-auto">
             <li class="nav-item active">
                 <a style="color: white;" class="nav-link" href="home_produksi.php">Home <span class="sr-only"></span></a>
             </li>
             <li class="nav-item">
                 <a style="color: white;" class="nav-link" href="#">Request</a>
            </li>
            </ul>
            <div class="collapse navbar-collapse" id="navbarText" >
                <ul class="navbar-nav ms-auto mb-5 mb-lg-0">
                <span  style="color: white; margin-right:15px;" class="navbar-text">Hello, Produksi!</span>
    ...
    <div style="width: 50% ;border: 2px solid black;border-radius: 5px; margin:70px 70px 70px 400px; padding: 30px;">
     <form name="formD" class="col-12 text-dark text-center" action="produksi_insert.php" method="post">
            <div>
              <center><h3><b>Request for Material</b><h3></center>
            </div>
        ...
        <div class="form-group">
                ...
                id="material" name="material" onchange="produk()">
           ...
           <script type="text/javascript">
            ...
            <div>    
                <button style="background-color: #8B2C28; color: white; margin:25px 0px 0px 617px;" class="btn btn" type="submit" value="Submit">Request</button> 
